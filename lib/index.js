...
module.exports = __webpack_require__(6)() ? String.prototype.contains : __webpack_require__(5);
...
module.exports = __webpack_require__(12)() ? Object.keys : __webpack_require__(11);
...
module.exports = __webpack_require__(15)() ? Object.assign : __webpack_require__(14);
...
var isValue         = __webpack_require__(2)
  , isPlainFunction = __webpack_require__(20)
  , assign          = __webpack_require__(16)
  , normalizeOpts   = __webpack_require__(8)
...
function SharedReducer(reducer) {
    let store = reducer([][0], {});
    let emitter = event_emitter__WEBPACK_IMPORTED_MODULE_0___default()();
    function useState() {
        const [state, setState] = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(store);
    ...
    return [useState, dispatch];
}
function createSelector(useStates, selector) {
    return function () {
        const states = useStates.map((us) => us());
        const [mergedState, setMergedState] = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(selector(states));
        Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(() => setMergedState(selector(states)), states);
        return mergedState;
    };
}
